...
backgroundimg = pygame.transform.scale(pygame.image.load("images.jpg").convert(), (SCREEN_WIDTH, SCREEN_HEIGHT))
isagiimg =pygame.transform.scale(pygame.image.load("sl.jpg").convert_alpha(), (200, 200))
